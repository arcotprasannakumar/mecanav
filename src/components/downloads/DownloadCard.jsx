    ...
    if (item.title.toLowerCase().includes("iso")) {
      return (
        <svg
          viewBox="0 0 24 24"
          fill="none"
          className="h-8 w-8 text-[#34b54a]"
          xmlns="http://www.w3.org/2000/svg"
        >
          <path
            d="M12 3 14.2 5.2 17 5.5 17.3 8.3 19.5 10.5 17.3 12.7 17 15.5 14.2 15.8 12 18 9.8 15.8 7 15.5 6.7 12.7 4.5 10.5 6.7 8.3 7 5.5 9.8 5.2 12 3Z"
            fill="currentColor"
          />
  ...
  return (
    <div className="rounded-[3px] bg-white px-6 py-6 shadow-[0_2px_8px_rgba(0,0,0,0.08)] transition-shadow duration-300 hover:shadow-[0_5px_16px_rgba(0,0,0,0.1)]">
      ...
      >
        ...
        <span
          className={`absolute inset-0 z-10 flex items-center justify-center gap-2 text-[15px] font-semibold transition-colors duration-150 ${
